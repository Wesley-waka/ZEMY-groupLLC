...
const Sustainability = () => {
  return (
    <div>
      <div className=' ' >
          <h2 className="text-center text-2xl font-semibold">Sustainability and Social Responsibility</h2> 
          <div className=" py-6 w-full">

            <div className="flex md:flex-wrap md:flex-row flex-col space-y-4  md:space-x-24 md:ml-36  mx-auto justify-center">
              <div className='w-56 mx-auto text-center bg-gray-100 p-4 rounded-lg text-burgundy  border-red-200 border-t-4'>
