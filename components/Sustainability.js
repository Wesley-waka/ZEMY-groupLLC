...
const Sustainability = () => {
  return (
    <div>
      <div className=' ' >
          <h2 className="text-center text-2xl font-semibold sm:my-6">Sustainability and Social Responsibility</h2> 
          <div className=" py-6 w-full">

            <div className="flex md:flex-wrap md:flex-row flex-col space-y-4  md:space-x-24   mx-auto justify-center">
